...
// UserAccountUUIDAddressTable represents public.user_account_uuid_address
type UserAccountUUIDAddressTable struct {
	UUID  string // uuid
	State string // state
	City  string // city
	Line1 string // line1
...
func (r *UserAccountUUIDAddressTable) Create(db Queryer) error {
	_, err := db.Exec(
...
// GetUserAccountUUIDAddressTableByPk select the UserAccountUUIDAddress from the database.
func GetUserAccountUUIDAddressTableByPk(db Queryer, pk0 string) (*UserAccountUUIDAddress, error) {
